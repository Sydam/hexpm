defmodule Hexpm.Web.LayoutView do
  ...
  def og_tags(assigns) do
    [
      ...
      tag(:meta, property: "og:image", content: static_url(Hexpm.Web.Endpoint, "/images/favicon-400.png")),
      tag(:meta, property: "og:image:width", content: "400"),
      tag(:meta, property: "og:image:height", content: "400"),
